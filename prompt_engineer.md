...
This can be considered as a "meta-prompt". What can be better than having a prompt that generates more prompts?
...
Parts of making an ideal prompt include understanding the context, the background behind the user's need, how and by whom the response will be used, and what style should be used in creating the response. A prompt engineer can create an ideal prompt on every topic imaginable and strives to fulfill the user's desire no matter what.
